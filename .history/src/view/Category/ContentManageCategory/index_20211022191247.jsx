...
function ModalEdit(props) {
    ...
    const handleEdit = () =>{
        console.log(document.getElementsByTagName('nameCategoryEdit').value);
    }
    return (
      <>
          ...
          <Modal.Body>
                    <Form noValidate class="FormEditCate">
                            <Row>
                                ...
                                <Form.Group as={Col} controlId="formGridNameCategory">
                                    <Form.Label>Tên thể loại</Form.Label>
                                    <Form.Control type='text' name="nameCategoryEdit" value={props.dataModal.tenTheLoai} required/>
                                    <Form.Control.Feedback type="invalid">Vui lòng nhập tên thể loại</Form.Control.Feedback>
                                </Form.Group>
                            </Row>
                    </Form>

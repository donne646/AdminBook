...
export default function ContentManageCategory() {
    ...
    const [lastId,setLasstId] = useState();
    ...
    useEffect(()=>{
        setLasstId(dataCategory[dataCategory.length])
    },[dataCategory])
                        ...
                        <Form noValidate validated={validated} onSubmit={(event)=>submitFormAdd(event)} className="FormAddCate">
                            <Row>
                                <Form.Group as={Col} controlId="formGridId">
                                    ...
                                    <Form.Control type='text' name="idCategory" defaultValue={lastId} readOnly required/>
                                </Form.Group>

                        ...
                        <Form noValidate validated={validated} onSubmit={(event)=>submitFormAdd(event)} class="FormAddCate">
                            <Row>
                                <Form.Group as={Col} controlId="formGridId">
                                    ...
                                    <Form.Control type='text' name="idCategory" value={getLast()+1} readOnly required/>
                                </Form.Group>
...
function ModalEdit(props) {
    ...
    const handleEdit = () =>{
        console.log(document.getElementsByName("nameCategory").value())
    }
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose} animation={false} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
          ...
          <Modal.Body>
                    <Form noValidate class="FormEditCate">
                            <Row>
                                <Form.Group as={Col} controlId="formGridId">
                                    <Form.Label>ID</Form.Label>
                                    <Form.Control type='text' name="idCategory" value={props.dataModal.id} readOnly required/>
                                </Form.Group>
                                <Form.Group as={Col} controlId="formGridNameCategory">
                                    <Form.Label>Tên thể loại</Form.Label>
                                    <Form.Control type='text' name="nameCategory" id="nameCategory" value={props.dataModal.tenTheLoai} required/>
                                    <Form.Control.Feedback type="invalid">Vui lòng nhập tên thể loại</Form.Control.Feedback>
                                </Form.Group>
                            </Row>
                    </Form>

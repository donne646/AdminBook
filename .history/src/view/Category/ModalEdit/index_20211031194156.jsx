                    ...
                    <Form noValidate className="FormEditCate">
                            <Row>
                                ...
                                <Form.Group as={Col} controlId="formGridNameCategory">
                                    ...
                                    <Form.Control type='text' name="nameCategory" defaultValue={props.dataModal.tenTheLoai} required onChange={(event)=>inputChange(event)}/>

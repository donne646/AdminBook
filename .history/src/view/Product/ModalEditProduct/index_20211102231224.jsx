                    ...
                    <Form noValidate validated={validated} className="FormEditProduct" onSubmit={(event)=>{handleEdit(event)}}>
                            ...
                            <Row>
                                ...
                                <Form.Group as={Col} controlId="formGridNumberPage">
                                    <Form.Label>Đơn giá</Form.Label>
                                    <Form.Control type='number' name="numberPage" defaultValue={props.dataModal.numberPage} required onChange={(event)=>inputChange(event)}/>
                                    <Form.Control.Feedback type="invalid">Vui lòng số trnag</Form.Control.Feedback>
                                </Form.Group>
                            </Row>
